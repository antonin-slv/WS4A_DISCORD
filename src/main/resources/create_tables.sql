...
(
    ...
    FOREIGN KEY (subject_id) REFERENCES Subject (id_sub) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (id_channel) REFERENCES Channel (id_chan) ON DELETE CASCADE,
    FOREIGN KEY (response_to) REFERENCES Message (id_msg) ON DELETE SET NULL
);
...
(
    ...
    FOREIGN KEY (id_msg) REFERENCES Message (id_msg) ON DELETE CASCADE
);
